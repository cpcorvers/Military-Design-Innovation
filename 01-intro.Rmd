...
```{r, fig.cap='Eenvoudig CLAS moderniseringsproces met positionering CD&E', echo=FALSE}
# img_dir <-
...
```{r, fig.cap='Van mulit projecten via 3-horizon model naar 'routekaarten' ', echo=FALSE}
# img_dir <-
