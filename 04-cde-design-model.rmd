...
Inzoomen op het ontwerpen van een effectbrenger zijn we steeds meer geïnteresseerd hoe we van rechts naar links kunnen ontwerpen. Dat wil zeggen vanuit een geambieerde situatie met beoogde effect stellen we ons een output, activiteit en effectbrenger voor. Deze verfijnen we door het combineren van mens, manieren en middel.

Ambitie en programma-ontwikkellijnen worden gearticuleerd met het 3-Horizon model van Bill Sharp. Begeleidt door een programma-manager wordt een routekaar van operationele wensen en behoefte opgesteld door de verantwoordelijk kennisadviseur en betrokken kenniswerkers en subject matter experts. Deze routekaart leidt ondermeer tot strategisch onderbouwde keuze voor het oppakken van ideeën en experimenten.
<!--
...
Met de 'continue dialoog' worden externe partijen in een vroegtijdig stadium betrokken in een thematisch programma of bij een technisch vraagstuk. De 'continue dialoog' kent een aantal stadia waarin het vraagstuk steeds concreter wordt beschreven met hulp van de verschillende partijen. Figuur (\@ref(fig:vraag-aanbod)) visualiseert een dialoog tussen vraag- en aanbod kant. In een aantal werksessies of stappen wordt toegewerkt naar het punt waarop de vraagarticulatie en aanbodarticulatie elkaar vinden. Afhankelijk van het vraagstuk en de context worden relevante partijen door SBID- gekoppeld aan de dialoog. De verantwoordelijk programma-manager voert de regie in de dialoog en draagt deze in een latere stap over aan de trajectbegeleider.
Mede door de complexiteit van wet- en regelgeving en botsende waarden is dit een ingewikkeld proces wat nog onvoldoende is getoetst in de praktijk.
